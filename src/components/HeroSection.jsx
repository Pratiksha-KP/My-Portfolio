...
export const HeroSection = () => {
    ...
    >
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          Turning Ideas Into Code While Mastering Web Development
          </p>
  ...
  >
    <span className="text-sm text-muted-foreground mb-2 hover:text-primary transition-colors duration-300">
      Scroll to About Me
    </span>
